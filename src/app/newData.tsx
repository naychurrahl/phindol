...
export function truncateWords(text: string, suffix = "...", wordLimit = 20) {
  if (!text) return "";
...
// Service Details (nested under services[].detail for life-insurance / corporate-insurance / claims-support)
export type ServiceIcon =
  | "Shield" | "Heart" | "Umbrella" | "TrendingUp" | "Users"
  | "Building2" | "Briefcase" | "FileText" | "Phone" | "Mail"
...
export type ServiceExtra =
  | { type: "quickContact"; title: string; items: { icon: ServiceIcon; label: string; value: string }[] }
  | { type: "steps"; title: string; items: { number: number; title: string; description: string }[] }
  | { type: "documents"; title: string; groups: { title: string; icon: ServiceIcon; items: string[] }[] }
  | { type: "tips"; title: string; items: string[] }
  | { type: "calculator"; title: string; description: string; fields: { label: string; placeholder: string }[]; buttonText: string; note: string }
  | { type: "industries"; title: string; items: string[] }
  | { type: "faq"; title: string; items: { question: string; answer: string }[] }
  | { type: "claimForm"; title: string; description: string };
...
export const services: ServiceItem[] = [
  ...
  },
  {
    ...
    benefits: {
      title: "Why You Need Life Insurance",
      items: [
        { icon: "Shield", title: "Financial Protection", description: "Ensures your loved ones are financially secure in the event of your passing." },
        { icon: "Heart", title: "Peace of Mind", description: "Know that your family will be taken care of no matter what happens." },
        { icon: "TrendingUp", title: "Future Planning", description: "Build wealth and achieve long-term financial goals with investment-linked policies." },
      ],
    },
    coverage: {
      title: "Our Life Insurance Plans",
      items: [
        {
          icon: "Umbrella",
          title: "Term Life Insurance",
          description: "Affordable coverage for a specific period, perfect for young families and those with temporary financial obligations.",
          features: [
        ...
        },
        {
          ...
          description: "Lifetime coverage with a cash value component that grows over time, providing both protection and savings.",
          features: [
    ...
    extras: [
      {
        ...
        description: "Use our simple calculator to estimate how much life insurance coverage you need.",
        fields: [
          { label: "Annual Income", placeholder: "₦5,000,000" },
          { label: "Number of Dependents", placeholder: "3" },
          { label: "Outstanding Debts", placeholder: "₦10,000,000" },
          { label: "Existing Savings", placeholder: "₦2,000,000" },
        ],
        buttonText: "Calculate Coverage",
        note: "This is an estimate only. Contact us for a personalized quote.",
      },
    ],
    cta: {
      title: "Ready to Protect Your Family?",
      description: "Let our experts help you find the perfect life insurance plan for your needs.",
  ...
  },
  {
    ...
    benefits: {
      title: "Why Your Business Needs Insurance",
      items: [
        { icon: "Shield", title: "Asset Protection", description: "Safeguard your property, equipment, and inventory." },
        { icon: "Users", title: "Employee Welfare", description: "Provide health and safety coverage for your team." },
        { icon: "FileText", title: "Liability Coverage", description: "Protect against legal claims and lawsuits." },
        { icon: "TrendingUp", title: "Business Continuity", description: "Ensure operations continue after disruptions." },
      ],
    },
    coverage: {
      title: "Our Corporate Insurance Solutions",
      items: [
        {
          icon: "Building2",
          title: "Property Insurance",
          description: "Comprehensive coverage for your business premises, equipment, and inventory.",
          features: ["Building and contents coverage", "Fire and natural disaster protection", "Theft and vandalism coverage"],
        },
        {
          icon: "Shield",
          title: "General Liability",
          description: "Protection against third-party claims for bodily injury and property damage.",
          features: ["Public liability coverage", "Product liability insurance", "Professional indemnity"],
        },
        {
          icon: "Users",
          title: "Employee Benefits",
          description: "Comprehensive health and welfare packages for your workforce.",
          features: ["Group health insurance", "Group life insurance", "Workman's compensation"],
        },
        {
          icon: "TrendingUp",
          title: "Business Interruption",
          description: "Coverage for lost income and operating expenses during disruptions.",
          features: ["Lost income replacement", "Operating expense coverage", "Temporary relocation costs"],
        },
        {
          icon: "Briefcase",
          title: "Professional Indemnity",
          description: "Protection for professionals against claims of negligence or errors.",
          features: ["Legal defense costs", "Compensation payments", "Errors and omissions cover"],
        },
        {
          icon: "FileText",
          title: "Cyber Insurance",
          description: "Protection against data breaches and cyber attacks in the digital age.",
          features: ["Data breach response", "Cyber liability coverage", "Business interruption losses"],
        },
      ],
    },
    extras: [
      {
        ...
        items: ["Manufacturing", "Retail & Hospitality", "Technology & IT", "Healthcare", "Construction", "Financial Services", "Education", "Professional Services"],
      },
    ],
    cta: {
      title: "Ready to Protect Your Business?",
      description: "Get a customized corporate insurance package tailored to your business needs.",
  ...
  },
  {
    ...
    extras: [
      {
        ...
        items: [
          { icon: "Phone", label: "24/7 Hotline", value: "+234 XXX XXX XXXX" },
          { icon: "Mail", label: "Email Support", value: "claims@phindolinsurance.com" },
      ...
      },
      {
        ...
        items: [
          { number: 1, title: "Report Your Claim", description: "Contact us immediately via phone, email, or our online form to report your claim." },
          { number: 2, title: "Provide Documentation", description: "Submit all required documents including policy details, incident reports, and supporting evidence." },
          { number: 3, title: "Claim Assessment", description: "Our claims team will review your submission and may schedule an assessment if needed." },
          { number: 4, title: "Approval & Payment", description: "Once approved, your claim will be processed and payment disbursed within the agreed timeframe." },
        ],
      },
      {
        type: "documents",
        ...
        groups: [
          ...
          {
            title: "Corporate Insurance Claims",
            icon: "FileText",
            items: [
      ...
      {
        type: "tips",
        title: "Important Tips for Filing Claims",
        items: [
          "Report your claim as soon as possible after the incident",
          "Keep all original documents and make copies for your records",
          "Take photographs of any damage or loss",
          "Do not dispose of damaged property until the claim is settled",
          "Cooperate fully with the claims assessor",
          "Keep track of all communication regarding your claim",
        ],
      },
      {
        type: "claimForm",
        title: "File a Claim Online",
        description: "Submit your claim details and our team will get back to you within 24 hours.",
      },
      {
        type: "faq",
        ...
        items: [
          {
            ...
            answer: "Most claims are processed within 7-14 business days after all required documents are submitted. Complex claims may take longer, but we keep you informed throughout the process.",
          },
          {
            question: "Can I track my claim status?",
            answer: "Yes! Once your claim is submitted, you'll receive a claim reference number. Contact our support team with this number to get real-time updates on your claim status.",
          },
          {
            question: "What if my claim is denied?",
            answer: "If your claim is denied, we'll provide a detailed explanation. You have the right to appeal the decision by providing additional information or documentation that supports your claim.",
          },
        ],
      },
    ],
    cta: {
      ...
      description: "Our support team is available 24/7 to assist you with your claims and answer any questions.",
...
// Gallery -- fallback shown until /gallery responds (or if it never does)
export const galleryFallback = {galleryImages: [
    {
      id: 1,
...
// Blog
// Blog -- fallback shown until /blog responds (or if it never does)
export const blogFallback = {blogPosts: [
    {
      id: 1,
...
// Testimonials -- fallback shown until /testimonials responds (or if it never does)
